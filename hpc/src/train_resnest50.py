...
if __name__ == "__main__":
    ...
    model = make_uresnet(layers="50", drop=0.4)           # <<< CHANGE MODEL HERE!! make_uresnest(layers="50"/"101"/"200", drop=0.0->0.9999...)
                                                          # make_unet() or make_u2net()
    #model = torch.load("/zhome/4e/8/181483/deep-learning-project/ResNeSt50_950_loss_trian_0.00529_val_0.00762.pt")
